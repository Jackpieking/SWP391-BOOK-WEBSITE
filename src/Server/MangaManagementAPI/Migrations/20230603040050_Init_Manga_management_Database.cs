    ...
    public partial class Init_Manga_management_Database : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("1ef67686-f4ad-48f2-b56c-c828ec53a8d5"), 1500, "C:\\Users\\USER\\Downloads\\pic1.jpg", new DateOnly(2023, 6, 3), "janesmith@example.com", "Jane Smith", 1, "12345678", "5550123456", "Jane Smith" },
                    { new Guid("2231dfa9-c0f7-49c9-b0af-dac2cac61c72"), 1000, "C:\\Users\\USER\\Downloads\\pic1.jpg", new DateOnly(2023, 6, 3), "johndoe@example.com", "John Doe", 0, "12345678", "1234567890", "John Doe" },
                    { new Guid("c6d20823-3d00-48a0-8074-36587bee2693"), 2000, "C:\\Users\\USER\\Downloads\\pic1.jpg", new DateOnly(2023, 6, 3), "alicethompson@example.com", "Alice Thompson", 2, "12345678", "7778889999", "Alice Thompson" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("4dfe12e0-cb8a-4282-8e74-3b1e8053f787"), new Guid("c6d20823-3d00-48a0-8074-36587bee2693"), new DateTime(2023, 6, 3, 4, 0, 50, 854, DateTimeKind.Utc).AddTicks(8269) },
                    { new Guid("5d34237a-f44c-4f3f-8495-2b36047e034e"), new Guid("c6d20823-3d00-48a0-8074-36587bee2693"), new DateTime(2023, 6, 3, 4, 0, 50, 854, DateTimeKind.Utc).AddTicks(8267) },
                    { new Guid("8aa5080b-0212-4b9c-9b70-0afc2bc4b99f"), new Guid("c6d20823-3d00-48a0-8074-36587bee2693"), new DateTime(2023, 6, 3, 4, 0, 50, 854, DateTimeKind.Utc).AddTicks(8268) },
                    { new Guid("aadadaf7-fc21-4559-a53c-f97eb1ba583f"), new Guid("c6d20823-3d00-48a0-8074-36587bee2693"), new DateTime(2023, 6, 3, 4, 0, 50, 854, DateTimeKind.Utc).AddTicks(8271) },
                    { new Guid("b8d6abf3-b7e0-4a20-8647-f8f4f1ac04d3"), new Guid("c6d20823-3d00-48a0-8074-36587bee2693"), new DateTime(2023, 6, 3, 4, 0, 50, 854, DateTimeKind.Utc).AddTicks(8264) }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("5d34237a-f44c-4f3f-8495-2b36047e034e"), new Guid("1ef67686-f4ad-48f2-b56c-c828ec53a8d5"), "I laughed so hard I cried!", (short)5, new DateTime(2023, 6, 3, 4, 0, 50, 854, DateTimeKind.Utc).AddTicks(8038) },
                    { new Guid("8aa5080b-0212-4b9c-9b70-0afc2bc4b99f"), new Guid("1ef67686-f4ad-48f2-b56c-c828ec53a8d5"), "I hated the ending.", (short)1, new DateTime(2023, 6, 3, 4, 0, 50, 854, DateTimeKind.Utc).AddTicks(8040) },
                    { new Guid("5d34237a-f44c-4f3f-8495-2b36047e034e"), new Guid("2231dfa9-c0f7-49c9-b0af-dac2cac61c72"), "The artwork is amazing!", (short)3, new DateTime(2023, 6, 3, 4, 0, 50, 854, DateTimeKind.Utc).AddTicks(7896) },
                    { new Guid("8aa5080b-0212-4b9c-9b70-0afc2bc4b99f"), new Guid("2231dfa9-c0f7-49c9-b0af-dac2cac61c72"), "The story line is hard to follow.", (short)2, new DateTime(2023, 6, 3, 4, 0, 50, 854, DateTimeKind.Utc).AddTicks(8037) },
                    { new Guid("8aa5080b-0212-4b9c-9b70-0afc2bc4b99f"), new Guid("c6d20823-3d00-48a0-8074-36587bee2693"), "I wanted more action scenes.", (short)4, new DateTime(2023, 6, 3, 4, 0, 50, 854, DateTimeKind.Utc).AddTicks(8044) }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("9e863f53-2515-44e5-a746-35afc78a0ca8"), 200000.0, new DateTime(2023, 6, 3, 4, 0, 50, 854, DateTimeKind.Utc).AddTicks(7781), 200, new Guid("1ef67686-f4ad-48f2-b56c-c828ec53a8d5") },
                    { new Guid("e5205803-deb8-401f-8cde-58149cdcc419"), 50000.0, new DateTime(2023, 6, 3, 4, 0, 50, 854, DateTimeKind.Utc).AddTicks(7779), 50, new Guid("2231dfa9-c0f7-49c9-b0af-dac2cac61c72") },
                    { new Guid("f256f2fa-579c-4495-aada-1cdcb122ae03"), 100000.0, new DateTime(2023, 6, 3, 4, 0, 50, 854, DateTimeKind.Utc).AddTicks(7775), 100, new Guid("2231dfa9-c0f7-49c9-b0af-dac2cac61c72") }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("3f5a415f-caa3-426b-8926-a11a55dc49b0"), new Guid("1ef67686-f4ad-48f2-b56c-c828ec53a8d5"), new DateTime(2023, 6, 3, 4, 0, 50, 854, DateTimeKind.Utc).AddTicks(8204) },
                    { new Guid("ef26e85e-4bd5-414f-9a2b-40bc43534523"), new Guid("1ef67686-f4ad-48f2-b56c-c828ec53a8d5"), new DateTime(2023, 6, 3, 4, 0, 50, 854, DateTimeKind.Utc).AddTicks(8200) },
                    { new Guid("3f5a415f-caa3-426b-8926-a11a55dc49b0"), new Guid("2231dfa9-c0f7-49c9-b0af-dac2cac61c72"), new DateTime(2023, 6, 3, 4, 0, 50, 854, DateTimeKind.Utc).AddTicks(8197) },
                    { new Guid("dc31637b-416c-458d-9942-74fa1470ca20"), new Guid("2231dfa9-c0f7-49c9-b0af-dac2cac61c72"), new DateTime(2023, 6, 3, 4, 0, 50, 854, DateTimeKind.Utc).AddTicks(8205) },
                    { new Guid("ef26e85e-4bd5-414f-9a2b-40bc43534523"), new Guid("2231dfa9-c0f7-49c9-b0af-dac2cac61c72"), new DateTime(2023, 6, 3, 4, 0, 50, 854, DateTimeKind.Utc).AddTicks(8202) }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("3f5a415f-caa3-426b-8926-a11a55dc49b0"), new Guid("1ef67686-f4ad-48f2-b56c-c828ec53a8d5"), "It's ok, but not great.", (short)3, new DateTime(2023, 6, 3, 4, 0, 50, 854, DateTimeKind.Utc).AddTicks(8127) },
                    { new Guid("3f5a415f-caa3-426b-8926-a11a55dc49b0"), new Guid("2231dfa9-c0f7-49c9-b0af-dac2cac61c72"), "It's the best thing I've read in years!", (short)5, new DateTime(2023, 6, 3, 4, 0, 50, 854, DateTimeKind.Utc).AddTicks(8124) },
                    { new Guid("dc31637b-416c-458d-9942-74fa1470ca20"), new Guid("2231dfa9-c0f7-49c9-b0af-dac2cac61c72"), "I didn't like it at all.", (short)2, new DateTime(2023, 6, 3, 4, 0, 50, 854, DateTimeKind.Utc).AddTicks(8130) },
                    { new Guid("94f15b6a-a89b-4546-82a4-98098bab83ff"), new Guid("c6d20823-3d00-48a0-8074-36587bee2693"), "It's pretty good!", (short)4, new DateTime(2023, 6, 3, 4, 0, 50, 854, DateTimeKind.Utc).AddTicks(8136) },
                    { new Guid("ab9d0e26-4c6e-40a8-97e3-1d5d012b4d80"), new Guid("c6d20823-3d00-48a0-8074-36587bee2693"), "It's the worst.", (short)1, new DateTime(2023, 6, 3, 4, 0, 50, 854, DateTimeKind.Utc).AddTicks(8134) }
                });
