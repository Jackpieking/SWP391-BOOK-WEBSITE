    ...
    public void Configure(EntityTypeBuilder<ComicEntity> builder)
    {
        ...
        ICollection<ComicEntity> comics = new List<ComicEntity>()
        {
            new()
            {
                ...
                ComicPublishDate = new(year: 2016, month: 11, day: 2),
                ComicLatestChapter = 205.6,
            ...
            new()
            {
                ...
                ComicPublishDate = new(year: 2018, month: 7, day: 25),
                ComicLatestChapter = 132,
            ...
            new()
            {
                ...
                ComicPublishDate = new(year: 2018, month: 3, day: 26),
                ComicLatestChapter = 232,
            ...
            new()
            {
                ...
                ComicPublishDate = new(year: 2015, month: 4, day: 18),
                ComicLatestChapter = 360,
            ...
            new()
            {
                ...
                ComicPublishDate = new(year: 2016, month: 5, day: 26),
                ComicLatestChapter = 302,
