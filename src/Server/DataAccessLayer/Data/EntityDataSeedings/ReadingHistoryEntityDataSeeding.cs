...
public class ReadingHistoryEntityDataSeeding : IEntityTypeConfiguration<ReadingHistoryEntity>
{
    /// <summary>
    ...
    public void Configure(EntityTypeBuilder<ReadingHistoryEntity> builder)
    {
        ...
        ICollection<ReadingHistoryEntity> readingHistories = new List<ReadingHistoryEntity>()
        {
            new()
            {
