...
public class ComicRepository : GenericRepository<ComicEntity>, IComicRepository
{
	...
	/// </summary>
	/// <returns></returns>
	public async Task<IList<ComicEntity>> GetComicsAsync() =>
	...
	/// </summary>
	/// <returns></returns>
	public async Task<IList<ComicEntity>> GetComicsWith_ComicId_ComicName_ComicPublishedDate_ComicAvatarAsync()
	{
		return await _dbSet
	...
	/// <returns></returns>
	public async Task<ComicEntity> GetComicWith_ComicName_ComicDescription_ComicAvatar_ComicPublishedDate_PublisherId_ByComicIdAsync(Guid comicIdentifier)
	{
		return await _dbSet
	...
	/// <returns></returns>
	public async Task<Guid> GetComicIdByComicNameAsync(string comicName)
	{
	...
	/// <param name="comicIdentifier"></param>
	/// <returns></returns>
	public async Task<ComicEntity> GetComicWith_ComicId_ComicName_ComicDescription_ComicAvatar_ComicPublishedDate_PublisherId_ByComicIdAsync(Guid comicIdentifier)
	{
		return await _dbSet
			.Where(predicate: comicEntity
				=> comicEntity.ComicIdentifier == comicIdentifier)
