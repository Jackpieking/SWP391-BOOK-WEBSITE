...
public class ComicCategoryRepository : GenericRepository<ComicCategoryEntity>, IComicCategoryRepository
{
	...
	/// <returns></returns>
	public async Task<IList<ComicCategoryEntity>> GetComicCategoryNamesByComicIdAsync(Guid comicIdentifier)
	{
		return await _dbSet
	...
	/// </summary>
	/// <param name="comicIdentifier"></param>
	public void DeleteComicCategoriesByComicId(Guid comicIdentifier)
	{
	...
	/// <returns></returns>
	public async Task UpdateCrawlDataAsync(Guid comicIdentifier, IList<Guid> categoryidentifiers)
	{
