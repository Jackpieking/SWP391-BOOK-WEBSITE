...
public class UserEntityConfiguration : IEntityTypeConfiguration<UserEntity>
{
    ...
    public void Configure(EntityTypeBuilder<UserEntity> builder)
    {
        ...
        // One to many: User => ComicLike
        builder
            .HasMany(navigationExpression: user => user.ComicLikeEntities)
            .WithOne(navigationExpression: comicLike => comicLike.UserEntity)
            .HasForeignKey(foreignKeyExpression: comicLike => comicLike.UserIdentifier)
            .OnDelete(deleteBehavior: DeleteBehavior.Cascade);
        ...
        builder
            ...
            .HasForeignKey(foreignKeyExpression: buyingHistory => buyingHistory.UserIdentifier)
            .OnDelete(deleteBehavior: DeleteBehavior.Cascade);
    }
}
